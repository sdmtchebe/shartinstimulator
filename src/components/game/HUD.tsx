...
export default function HUD(props: HUDProps) {
  const { money, hunger, chud, day, timeStr, hp, hpMax, sceneName, muted, onTogglePhone, onToggleMute, questsDone, questsTotal, dailyEvent } = props;
  ...
  return (
    <div className="absolute inset-0 pointer-events-none z-20">
      ...
      <div className="absolute top-20 left-3 flex flex-col gap-3 w-44">
        ...
        <Bar label="Chud" value={chud} max={100} color={chudColor} caption={chud >= 90 ? "DANGER" : ""} />
