...
export const SCENE_INTERESTS: Record<string, { x: number; y: number }[]> = {
  ...
  outside: [
    // Top road (y ~660) — near building doors
    { x: 430, y: 560 }, { x: 1070, y: 560 }, { x: 1560, y: 580 },
    { x: 2070, y: 580 }, { x: 2540, y: 580 },
    // Vertical road left (x ~860)
    { x: 860, y: 350 }, { x: 860, y: 660 }, { x: 860, y: 1000 },
    // Middle road (y ~1440) — near building doors
    { x: 450, y: 1340 }, { x: 850, y: 1340 }, { x: 1250, y: 1340 },
    { x: 1660, y: 1340 }, { x: 2050, y: 1340 },
    // Vertical road right (x ~2280)
    { x: 2280, y: 660 }, { x: 2280, y: 1000 }, { x: 2280, y: 1440 },
    // Bottom road (y ~1940) — near building doors
    { x: 450, y: 1940 }, { x: 850, y: 1940 }, { x: 1250, y: 1940 },
    { x: 1660, y: 1940 }, { x: 2050, y: 1940 },
    // Open areas between roads
    { x: 600, y: 900 }, { x: 1400, y: 900 }, { x: 2100, y: 900 },
    { x: 600, y: 1600 }, { x: 1400, y: 1600 }, { x: 2100, y: 1600 },
  ],
  tutorat: [
...
export const SCENES: Record<string, SceneDef> = {
  ...
  "garage": {
    ...
    doors: [
      { id: "exit", x: 350, y: 320, w: 100, h: 30, targetScene: "outside", targetPos: { x: 560, y: 600 }, label: "Outside", color: COLORS.doorway },
    ],
    interactables: [
