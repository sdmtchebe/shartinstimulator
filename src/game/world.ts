...
export const NPC_DEFS: NpcDef[] = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { startHour: 17, endHour: 18, scene: "nelly", activity: "wander" },
      { startHour: 18, endHour: 19, scene: "outside", activity: "wander" },
      { startHour: 19, endHour: 10, scene: "apartments", activity: "static" },
    ],
  },
  ...
  },
  {
    ...
    schedule: [
      ...
      { startHour: 14, endHour: 16, scene: "asbestos", activity: "wander" },
      { startHour: 16, endHour: 17, scene: "outside", activity: "wander" },
  ...
  },
  {
    ...
    schedule: [
      { startHour: 10, endHour: 12, scene: "asbestos", activity: "wander" },
      { startHour: 12, endHour: 14, scene: "chudzone", activity: "wander" },
