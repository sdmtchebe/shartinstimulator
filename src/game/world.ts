...
export const NPC_DEFS: NpcDef[] = [
  {
    ...
    schedule: [
      { startHour: 10, endHour: 12, scene: "tutorat", activity: "guard", targetX: 450, targetY: 400 },
      { startHour: 12, endHour: 14, scene: "court", activity: "wander", targetX: 460, targetY: 300 },
      { startHour: 14, endHour: 16, scene: "fightclub", activity: "wander" },
      { startHour: 16, endHour: 18, scene: "outside", activity: "wander" },
      { startHour: 18, endHour: 19, scene: "chudzone", activity: "wander" },
  ...
  },
  {
    ...
    schedule: [
      { startHour: 10, endHour: 12, scene: "apartments", activity: "wander", targetX: 100, targetY: 250 },
      { startHour: 12, endHour: 14, scene: "outside", activity: "soccer", targetX: 1100, targetY: 760 },
      { startHour: 14, endHour: 16, scene: "gym", activity: "wander" },
      { startHour: 16, endHour: 18, scene: "tutorat", activity: "wander" },
      { startHour: 18, endHour: 19, scene: "court", activity: "wander" },
      { startHour: 19, endHour: 10, scene: "apartments", activity: "static" },
    ],
  },
  {
    ...
    schedule: [
      { startHour: 10, endHour: 12, scene: "apartments", activity: "wander", targetX: 100, targetY: 350 },
  ...
  },
  {
    ...
    schedule: [
      { startHour: 10, endHour: 12, scene: "apartments", activity: "wander", targetX: 700, targetY: 450 },
      { startHour: 12, endHour: 14, scene: "outside", activity: "wander" },
      { startHour: 14, endHour: 16, scene: "nelly", activity: "wander" },
      { startHour: 16, endHour: 18, scene: "chudzone", activity: "wander" },
      { startHour: 18, endHour: 19, scene: "nelly", activity: "wander" },
      { startHour: 19, endHour: 10, scene: "apartments", activity: "static" },
    ],
  },
  {
    ...
    schedule: [
      { startHour: 10, endHour: 12, scene: "apartments", activity: "wander", targetX: 700, targetY: 350 },
      { startHour: 12, endHour: 14, scene: "outside", activity: "eat" },
      { startHour: 14, endHour: 16, scene: "chudzone", activity: "wander" },
      { startHour: 16, endHour: 17, scene: "asbestos", activity: "wander" },
      { startHour: 17, endHour: 18, scene: "outside", activity: "wander" },
      { startHour: 18, endHour: 19, scene: "fightclub", activity: "wander" },
      { startHour: 19, endHour: 10, scene: "apartments", activity: "static" },
    ],
  },
  {
    ...
    schedule: [
      { startHour: 10, endHour: 12, scene: "apartments", activity: "wander", targetX: 100, targetY: 450 },
      { startHour: 12, endHour: 14, scene: "outside", activity: "wander" },
      { startHour: 14, endHour: 16, scene: "gym", activity: "wander" },
      { startHour: 16, endHour: 18, scene: "tutorat", activity: "wander" },
      { startHour: 18, endHour: 19, scene: "outside", activity: "watchTV" },
      { startHour: 19, endHour: 10, scene: "apartments", activity: "static" },
    ],
  },
  {
    ...
    schedule: [
      { startHour: 10, endHour: 12, scene: "apartments", activity: "wander", targetX: 750, targetY: 450 },
      { startHour: 12, endHour: 14, scene: "asbestos", activity: "wander" },
      { startHour: 14, endHour: 16, scene: "chudzone", activity: "wander" },
      { startHour: 16, endHour: 18, scene: "outside", activity: "wander" },
      { startHour: 18, endHour: 19, scene: "nelly", activity: "wander" },
      { startHour: 19, endHour: 10, scene: "apartments", activity: "static" },
  ...
  },
  {
    ...
    schedule: [
      { startHour: 10, endHour: 12, scene: "apartments", activity: "wander", targetX: 700, targetY: 250 },
      { startHour: 12, endHour: 14, scene: "tutorat", activity: "wander" },
      { startHour: 14, endHour: 16, scene: "outside", activity: "wander" },
      { startHour: 16, endHour: 18, scene: "chudzone", activity: "wander" },
      { startHour: 18, endHour: 19, scene: "gym", activity: "wander" },
      { startHour: 19, endHour: 10, scene: "apartments", activity: "static" },
    ],
  },
  {
  ...
  },
  {
    ...
    schedule: [
      { startHour: 10, endHour: 14, scene: "fishing", activity: "wander" },
      { startHour: 14, endHour: 16, scene: "nelly", activity: "wander" },
      { startHour: 16, endHour: 18, scene: "fishing", activity: "wander" },
      { startHour: 18, endHour: 19, scene: "outside", activity: "wander" },
      { startHour: 19, endHour: 20, scene: "nelly", activity: "wander" },
      { startHour: 20, endHour: 10, scene: "fishing", activity: "static" },
    ],
  },
  {
...
export const SCENES: Record<string, SceneDef> = {
  outside: {
    ...
    buildings: [
      ...
      { x: 2380, y: 280, w: 320, h: 260, label: "Chud Zone" },
      { x: 320, y: 1100, w: 260, h: 200, label: "Moggayla's Apt" },
      { x: 720, y: 1080, w: 260, h: 220, label: "Cartier Santos Shop" },
      { x: 1120, y: 1100, w: 260, h: 200, label: "Nelly's Belly Bar" },
      { x: 1520, y: 1080, w: 280, h: 220, label: "Daron's Gym" },
